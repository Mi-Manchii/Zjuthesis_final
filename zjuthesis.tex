...
\documentclass[
    ...
    % Title
    Title           = 基于链上交易特征的Solana MEV机器人账户检测研究,
    TitleEng        = {{Research on Detecting Solana MEV Bot Accounts Based on On-Chain Transaction Characteristics}}
]{zjuthesis}
